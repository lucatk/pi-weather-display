...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.lblHumidity.setGeometry(QtCore.QRect(441, 195, 341, 141))
        font = QtGui.QFont()
        font.setFamily("Roboto")
        ...
        self.lblLightLevel.setGeometry(QtCore.QRect(30, 30, 371, 31))
        font = QtGui.QFont()
        font.setFamily("Roboto")
        ...
        self.lblSmokeLevel.setGeometry(QtCore.QRect(30, 64, 371, 31))
        font = QtGui.QFont()
        font.setFamily("Roboto")
        font.setPointSize(20)
